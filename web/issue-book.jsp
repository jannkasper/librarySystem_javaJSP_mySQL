...
<div class="main bar-option row">
    <ul>
        <div class="column" style="width:30%;">
            <li style="margin-left:50px;"><p>Search by book</p></li>
        </div>
...
<div class="main row">
    <div class="column" style="width:60%;">
        <h2 style="margin-left: 50px">Book Issue History</h2>
        <hr>
        <form action="/library/issue-book.jsp" method="post">
            <div class="container">
                <label ><b>BOOK BAR CODE</b></label>
                <input type="text" placeholder="Enter Book Bar Code" name="bookBarCode" required>
    ...
    <div class="column container" style="width:100%;">
        <div class="tableBorder" style="float: initial; width:100%;">
            ...
            <sql:query dataSource="${myDS}" var="listUsers">
                ...
                WHERE bookItemDB.barCode = <%=request.getParameter("bookBarCode")%>
                ;
            </sql:query>
