...
<div class="main bar-option row">
    <ul>
        <div class="column" style="width:30%;">
            <li style="margin-left:50px;"><p>Search by student</p></li>
        </div>
...
<div class="main row">
    <div class="column" style="width:60%;">
        <h2 style="margin-left: 50px">Student Issue History</h2>
        <hr>
        <form action="/library/issue-student.jsp" method="post">
            <div class="container">
                <label ><b>STUDENT NAME OR ADMISSION NO.</b></label>
                <input type="text" placeholder="Enter Student Name or Admission No." name="studentDetails" required>
    ...
    <div class="column container" style="width:100%;">
        <div class="tableBorder" style="float: initial; width:100%;">
            ...
            <sql:query dataSource="${myDS}" var="listUsers">
                <% String name = request.getParameter("studentDetails");
                    int admissionNo;
                    if (request.getParameter("studentDetails") == null) {
                        admissionNo =0;
                        name = "+_+_+_+";
                    } else {
                        boolean isNumeric = name.chars().allMatch( Character::isDigit );
                        if(isNumeric) {
                            admissionNo = Integer.parseInt(request.getParameter("studentDetails"));
                            name = "+_+_+_+";
                        } else {
                            admissionNo = 0;
                            name = request.getParameter("studentDetails");
                        }
                    };%>
                ...
                WHERE studentDB.name LIKE "%<%= name%>%" OR studentDB.admissionNo=<%= admissionNo%>
                ;
            </sql:query>
